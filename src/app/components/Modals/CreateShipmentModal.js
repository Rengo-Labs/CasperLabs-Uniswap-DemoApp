...
function CreateShipmentModal(props) {
    ...
    return (
        <Modal show={props.showCreateShipmentModal} onHide={props.handleCloseCreateShipmentModal} size="xl">
            ...
            <Modal.Footer>
                <button className="btn btn-danger" onClick={props.handleCloseCreateShipmentModal}>
                    Close
          </button>

                {props.isCreatingShipment ? (
                    <Spinner
                        animation="border"
                        role="status"
                    ...
                    >
                        ...
                        inputList.length === 0 ? (
                            <button className="btn btn-success" disabled>
                                ...
                                <button className="btn btn-success" onClick={() => props.createShipment(inputList)}>
                                    Create Shipment
                                </button>)
