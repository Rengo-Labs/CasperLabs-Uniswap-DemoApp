...
function ImporterDashboardDefaultScreen(props) {
  let [orderPlaced, setOrderPlaced] = useState(0);
  let [orderReceived, setOrderReceived] = useState(0);
  let jwt = Cookies.get("Authorization");
  let jwtDecoded = jwtDecode(jwt);
  let importerId = jwtDecoded.id;

  let getCounts = () => {
    axios
      .get("/api/v1/importer/getOrderCounts/" + importerId)
      .then((response) => {
      ...
      <div className="page-header">
        <div className="row">
          <div className="col-sm-12">
            <h3 className="page-title">Welcome Importer!</h3>
...
export default ImporterDashboardDefaultScreen;
